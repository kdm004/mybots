...
numberOfGenerations = 8 # change to 10 to complete quadruped
populationSize = 8 # change to 10 to complete quadruped

motorJointRange = .28 # set to .2 for oscillatory motion ... step 55 quadruped
