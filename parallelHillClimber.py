...
class PARALLEL_HILL_CLIMBER:
    ...
    def Results(self):
        numpy.savetxt('resultsTriped2.out', self.record, delimiter=',', fmt='%.4f') #LOOK
        numpy.save('resultsTriped2'+'.npy', self.record) #LOOK
        numpy.savetxt('resultsTriped2_'+str(random.randint(3,99999))+'.csv', self.record, delimiter=',', fmt='%.4f') #LOOK