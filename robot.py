...
class ROBOT:
    ...
    def Act(self,t):
        ...
        #Sphere11
        #p.applyExternalForce(objectUniqueId=self.robot, linkIndex=-1, forceObj=[5,-1,-5] , posObj=[3 , 2 , 6], flags=p.LINK_FRAME)
        #Sphere12
...
#---------------------------------------------
    ...
    def Get_Fitness(self):
        ...
        self.xCoordinateOfLinkZero = positionOfLinkZero[0]
