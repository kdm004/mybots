...
class ROBOT:
    def __init__(self,solutionID, swarmNumber, botNumber, overallBot = None):
        ...
        self.Prepare_To_Act()
        self.nn = NEURAL_NETWORK(f"brains/brain_{self.swarmNumber}_{self.botNumber}_{self.solutionID}.nndf", self.robot)        
    ...
    def Prepare_To_Sense(self):
        ...
        for linkName in pyrosim.linkNamesToIndices:
            self.sensors[linkName] = SENSOR(self.robot, linkName)
