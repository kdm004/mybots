...
# Upper Extremities
        ...
        pyrosim.Send_Sphere(name="BackLeg", pos=[x1,y1,z1] , size=[.5,.5,.5])

        #Front Leg
        pyrosim.Send_Joint( name = "Torso_FrontLeg" , parent= "Torso" , child = "FrontLeg" , type = "revolute", position = [0,0.5,1], jointAxis = "1 0 0")
        pyrosim.Send_Sphere(name="FrontLeg", pos=[x2,y2,z2] , size=[.5,.5,.5])

        #Left Leg
        pyrosim.Send_Joint( name = "Torso_LeftLeg" , parent= "Torso" , child = "LeftLeg" , type = "revolute", position = [-0.5,0,1], jointAxis = "0 1 0")
        pyrosim.Send_Sphere(name="LeftLeg", pos=[x3,y3,z3] , size=[.5,.5,.5])

        #Right Leg
        pyrosim.Send_Joint( name = "Torso_RightLeg" , parent= "Torso" , child = "RightLeg" , type = "revolute", position = [0.5,0,1], jointAxis = "0 1 0")
        pyrosim.Send_Sphere(name="RightLeg", pos=[x4,y4,z4] , size=[.5,.5,.5])

# Lower Extremities
        #Back Lower Leg
        pyrosim.Send_Joint( name = "BackLeg_BackLowerLeg" , parent= "BackLeg" , child = "BackLowerLeg" , type = "revolute", position = [0, -1, 0], jointAxis = "1 0 0")
        pyrosim.Send_Sphere(name="BackLowerLeg", pos=[0, 0, -0.5] ,size=[.5,.5,.5])
        
        #Front Lower Leg
        pyrosim.Send_Joint( name = "FrontLeg_FrontLowerLeg" , parent= "FrontLeg" , child = "FrontLowerLeg" , type = "revolute", position = [0, 1, 0], jointAxis = "1 0 0")
        pyrosim.Send_Sphere(name="FrontLowerLeg", pos=[0, 0, -0.5] , size=[.5,.5,.5])

        #Left Lower Leg
        pyrosim.Send_Joint( name = "LeftLeg_LeftLowerLeg" , parent= "LeftLeg" , child = "LeftLowerLeg" , type = "revolute", position = [-1, 0, 0], jointAxis = "0 1 0")
        pyrosim.Send_Sphere(name="LeftLowerLeg", pos=[0, 0, -0.5] , size=[.5,.5,.5])

        #Right Lower Leg
        pyrosim.Send_Joint( name = "RightLeg_RightLowerLeg" , parent= "RightLeg" , child = "RightLowerLeg" , type = "revolute", position = [1, 0, 0], jointAxis = "0 1 0")
        pyrosim.Send_Sphere(name="RightLowerLeg", pos=[0, 0, -0.5] , size=[.5,.5,.5])
